...
struct DataMarshallingExamplesSpec : winrt::Microsoft::ReactNative::TurboModuleSpec {
  static constexpr auto methods = std::tuple{
      Method<void(bool, int, double, std::string) noexcept>{0, L"ExplicitPrimtiveArgs"},
  ...
  static constexpr void ValidateModule() noexcept {
    ...
    REACT_SHOW_METHOD_SPEC_ERRORS(
          ...
          "    REACT_METHOD(ExplicitPrimtiveArgs) void ExplicitPrimtiveArgs(bool b, int i, double d, std::string s) noexcept { /* implementation */ }\n"
          "    REACT_METHOD(ExplicitPrimtiveArgs) static void ExplicitPrimtiveArgs(bool b, int i, double d, std::string s) noexcept { /* implementation */ }\n");
    REACT_SHOW_METHOD_SPEC_ERRORS(
          1,
