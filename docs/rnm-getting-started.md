...
Please visit the [0.71 version of the Getting Started guide](https://microsoft.github.io/react-native-windows/docs/0.71/rnm-getting-started) to build React Native for macOS apps.
