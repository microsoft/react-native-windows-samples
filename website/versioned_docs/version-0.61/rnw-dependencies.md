...
You can run React-Native for Windows apps only on Windows 10 devices with Windows version: 10.0.16299.0 or higher (aka 1709, aka Redstone 3, aka Fall Creators Update). See [Windows 10 Compatibility](win10-compat.md) for version support details.
