---
id: version-0.82-native-platform-getting-started
...
```bat
npx --yes create-react-native-library@0.48.9 --react-native-version "^0.82.0" <projectName>
```
...
```bat
yarn add react-native-windows@^0.82.0 --dev
