...
To read more about this new experience in Windows, check out the blog post on [React Native for Windows is helping Settings improve more quickly.](aka.ms/rnwsettingsblog).
